...
res.CPTAC.MSstats.full <- res.CPTAC.MSstats %>% arrange(adj.pvalue,pvalue)
res.CPTAC.MSstats.full <- as_tibble(cbind(res.CPTAC.MSstats.full[,1], UPS = grepl("ups", res.CPTAC.MSstats.full$protein), res.CPTAC.MSstats.full[,-1]))
