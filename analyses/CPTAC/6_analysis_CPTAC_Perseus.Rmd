...
CPTAC.Perseus.full$q.BH <- p.adjust(CPTAC.Perseus.full$p.value, method = "BH") # Benjamini-Hochberg FDR
CPTAC.Perseus.full
...
CPTAC.Perseus.imp.full$q.BH <- p.adjust(CPTAC.Perseus.imp.full$p.value, method = "BH") # Benjamini-Hochberg FDR
