...
## 3. Assess different ways of preprocessing for ProPCA: generate peptide-level data without quantile normalization

```{r eval=TRUE}
### Same as in 1_analysis_CPTAC_MSqRob.Rmd, but now without quantile normalization

### 1. Log transform the data.
peptides.CPTAC.no.QN <- log(peptides.CPTAC.no.QN, base = 2)
...
## 4. Summarize the data with ProPCA
