...
# res.CPTAC <- do_mm(formula = form, msnset = peptides.CPTAC3, group_var = protein, contrasts = contrasts, type_df = "conservative", max_iter = 20) # Takes about 10 mins. on our system.
