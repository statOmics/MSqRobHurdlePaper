...
# 4. Histograms for the effects of all imputations at peptide-level, grouped per condition (Supplementary Fig. 5)
...
colors <- c("peru", "#FFC30B", "magenta", "#42B7BA", "#1B2944", "#FF681E", "#5A2A82")

sort.list <- list(c("qvalue", "pvalue", "logFC"),
     c("qvalue", "pvalue"),
     c("qval", "pval", "t", "logFC"),
...
colors <- c("red2", "green", "#808000", "yellow3", "black", "#FF681E", "#5A2A82")
