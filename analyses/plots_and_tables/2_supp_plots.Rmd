...
## 1. Evaluate the missing values in PRIDE projects (Supplementary Fig. 1)
...
### 1.3. Make the histogram in Supplementary Fig. 1.
...
### 2.1. Prepare for the imputation figures: imputation at the protein level
...
### 2.2. Evaluate Perseus imputation at the MaxLFQ protein level (Supplementary Fig. 2)
...
## 3. Evaluate Perseus imputation at the peptide level (Supplementary Fig. 3)
...
## 4. Histograms for the effects of all imputations at the protein level, grouped per condition (Supplementary Fig. 4)
...
## 5. Histograms for the effects of all imputations at peptide-level, grouped per condition (Supplementary Fig. 5)
...
### 6.2. Make the FDR-FTP plots for the imputation-based methods (Supplementary Fig. 6)
...
## 7. Make the FDR-FTP plots for the count-based methods (Supplementary Fig. 7)
...
## 8. Intensities and counts provide complementary information for detecting differentially abundant proteins (Supplementary Fig. 8)
...
## 9. On the independence of the z-statistics under the null hypothesis  (Supplementary Fig. 9)
...
## 10. Make the FDR-FTP plots for the methods that do not use Benjamini-Hochberg FDR correction as their default (i.e. Perseus and DEP) (Supplementary Fig. 10)
...
## 11. For the common set, make the FDR-FTP plots for MaxLFQ-based state-of-the-art methods (Supplementary Fig. 11)
...
## 12. For the common set, make the FDR-FTP plots for peptide-based state-of-the-art methods methods (Supplementary Fig. 12)
...
## 13. Plot example proteins for each of the overlapping regions in the Venn diagram (Supplementary Fig. 13 - 17)
...
## 14. Generate the data for the other Venn diagrams for the HEART dataset (Supplementary Fig. 18)
